...
/**
 * Interface OpenAPI para os endpoints de gestão e roteamento de tickets no Dashboard.
 */
...
public interface TicketControllerOpenApi {
    ...
    @Operation(
            summary = "Criar e Rotear Solicitação",
            description = "Recebe uma nova solicitação de atendimento contendo a referência da conversa (chatRef) e o assunto. "
    ...
    @Operation(
            ...
            description = "Finaliza a solicitação de atendimento ativa identificada pelo ID (Status: RESOLVED). "
